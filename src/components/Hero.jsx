...
const Hero = () => {
 ...
 violet-gradient' />
  ...
  <div>
    ...
    Hey,I'm <span className='text-[#915eff]'>Vivin</span></h1>
  ...
  <ComputersCanvas />
     ...
     bottom-46 w-full flex justify-center items-center'>
<a href='#about'>
  <div
  className='w=[35px] h-[48px] rounded-3xl border-4 border-secondary
